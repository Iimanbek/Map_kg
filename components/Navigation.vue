<template >
    <div class="fixed w-full">
                ...
                <div class="flex justify-around items-center">
                    ...
                    <div class="text-white">
                        <div>
                            <div>
                                <button class="
                                                pt-[8px] hover:text-white hover:border-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
                                        <path
        ...
        <div v-show="isOpen" class="z-50 flex duration-150">
            <div :class="isOpen ? 'w-40' : 'w-60'" class="flex flex-col h-screen p-3 duration-300 bg-blue-500 shadow">
                <div class="space-y-3">
                        ...
                        <ul class="pt-2 pb-4 space-y-1 text-sm">
                            ...
                            <li class="rounded-sm">
                                <a href="#" @click="this.$router.push('/About')"
                                    ...
                                    <span class="text-gray-100">About card</span>
                                </a>
                            </li>
                            <li @click="this.$router.push('/')" class="rounded-sm">
                                <a href="#" class="flex items-center p-2 space-x-3 rounded-md">
                                    ...
                                    <span class="text-gray-100"> News </span>
                                </a>
                            </li>
                            <li class="rounded-sm">
                                <a href="#" class="flex items-center p-2 space-x-3 rounded-md">
